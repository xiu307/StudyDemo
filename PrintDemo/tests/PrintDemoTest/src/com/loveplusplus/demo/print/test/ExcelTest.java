...
public class ExcelTest extends AndroidTestCase {
	...
	public void test() throws IOException {
		...
		File file=FileUtils.createExcelToSDCard(mContext,"hello");
		Map<String, String> map = new HashMap<String, String>(); 

		map.put("demo_sno", "编号：20130305001");
		...
		ExcelUtil.excel(mContext, file, "demo.xls", "demo_", map);
